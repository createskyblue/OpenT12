...
enum HANDLETRIGGER {
    HANDLETRIGGER_VibrationSwitch_CHANNEL_1 = 0,
    HANDLETRIGGER_ReedSwitch_CHANNEL_1,
    HANDLETRIGGER_ReedSwitch_CHANNEL_2,
    HANDLETRIGGER_MIX_CHANNEL_1_AND_CHANNEL_2,
};
